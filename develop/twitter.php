...
$consumer_key = "n8DqD0XJk9jGFF8LtXdqF18vP"; 
$consumer_secret = "5RXUzC51hBgDGrcB1A5hv3VlpqSfFVz5c6FJyg6QkXuZXj2YYD";
$oauth_access_token = "113149706-U7410bty21TMsHmEh5pMqhyeWbv001pQGoj2poEW"; 
$oauth_access_token_secret = "0kKbX5WLFcf7vdGmvngx9ObuFobNxweXn1jggSdGUMZrg";
...
switch($_GET['url'])
{
	case 'friends':
	$rest = 'friends/ids' ;
	$params = Array('screen_name' => $_GET['screenName']);
	break;
	case 'timeline':
	$rest = 'statuses/user_timeline' ;
	$params = Array('count' => $_GET['count'], 'include_rts' => $_GET['include_rts'], 'exclude_replies' => $_GET['exclude_replies'], 'user_id' => $_GET['user_id']);
	break;
	case 'search':
	$rest = "search/tweets";
